<template>
  <v-container fluid class="mt-12 text-grey-lighten-2">
    <v-row dense>
      <v-col cols="12" class="text-center text-h1">
        <h1>4<span class="text-ternary">0</span>4</h1>
      </v-col>
      <v-col cols="12" class="text-center text-h3">
        <h2><span class="text-ternary">Not</span> Found</h2>
      </v-col>
    </v-row>
