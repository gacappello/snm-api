...
/**
 * @openapi
 * /playlists/insert/tag/{id}:
 *   put:
 *     summary: Insert a tag into a playlist
 *     operationId: insertTagIntoPlaylistById
 *     tags:
 *       - Playlists
 *     security:
 *       - CookieAuth: []
 ...
 *         in: path
 *         required: true
 *         description: ID of the playlist to insert the tag into
 *         schema:
 *           type: string
 *           example: 60c72b2f5f1b2c6d88c485e1
 *     requestBody:
 ...
 *               tag:
 *                 type: string
 *                 description: Tag to insert into the playlist
 *                 example: "rock"
 *     responses:
 *       204:
 *         description: Tag inserted into the playlist successfully
 *       400:
 *         description: Invalid tag or bad request
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/BadRequest'
 *       401:
 *         description: Unauthorized to insert tag into the playlist
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Unauthorized'
...
/**
 * @openapi
 * /playlists/remove/tag/{id}:
 *   put:
 *     summary: Remove a tag from a playlist
 *     operationId: removeTagFromPlaylistById
 *     tags:
 *       - Playlists
 *     security:
 *       - CookieAuth: []
 ...
 *         in: path
 *         required: true
 *         description: ID of the playlist to remove the tag from
 *         schema:
 *           type: string
 *           example: 60c72b2f5f1b2c6d88c485e1
 *     requestBody:
 ...
 *               tag:
 *                 type: string
 *                 description: Tag to remove from the playlist
 *                 example: "rock"
 *     responses:
 *       204:
 *         description: Tag removed from the playlist successfully
 *       401:
 *         description: Unauthorized to remove tag from the playlist
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Unauthorized'
